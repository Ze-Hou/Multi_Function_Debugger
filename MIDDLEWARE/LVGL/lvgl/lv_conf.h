...
#define LV_FONT_CUSTOM_DECLARE LV_FONT_DECLARE(lv_font_simsun_12)   \
                               ...
                               LV_FONT_DECLARE(lv_font_fzst_12)     \
                               LV_FONT_DECLARE(lv_font_fzst_16)     \
                               LV_FONT_DECLARE(lv_font_fzst_24)     \
                               LV_FONT_DECLARE(lv_font_fzst_32)     \
                               LV_FONT_DECLARE(lv_font_fzst_48)     \
                               LV_FONT_DECLARE(lv_font_fzst_56)

/*Always set a default font*/
//#define LV_FONT_DEFAULT &lv_font_montserrat_14
#define LV_FONT_DEFAULT &lv_font_fzst_16
...
#if LV_USE_FS_FATFS
    #define LV_FS_FATFS_LETTER 'C'     /*Set an upper cased letter on which the drive will accessible (e.g. 'A')*/
