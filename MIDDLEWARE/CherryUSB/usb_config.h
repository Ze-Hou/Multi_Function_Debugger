...
#define USE_USB_HS                  1           /* Enable USB High Speed */
#define USE_USB_0                   1           /* Enable USB HS0 port */
#define USE_USB_1                   0           /* Enable USB HS1 port */
#define USE_USB_DMA                 1           /* Enable USB DMA transfer */
#define USE_USBDEV_ADVANCE_DESC     1           /* Enable advanced USB descriptor */
...
#ifdef CONFIG_USB_HS
    #define USB_MAX_MPS 512
#else
    #define USB_MAX_MPS 64
#endif

#if USE_USBDEV_ADVANCE_DESC
...
#define CONFIG_USBDEV_MSC_MAX_BUFSIZE (1024 * 64)
#endif
 ...
 */
#define CONFIG_USB_DWC2_RXALL_FIFO_SIZE (1536 / 4)
