/*!
    \file       usb_dwc2_reg.h
    \brief      USB DWC2 register definitions and hardware abstraction layer
    \version    1.0
    \date       2025-07-25
    \author     Ze-Hou
...
#ifndef __USB_DWC2_REG_H
#define __USB_DWC2_REG_H
#include <stdint.h>

#define USBHS0                        0x40040000            
#define USBHS1                        0x40080000
...
typedef struct
{
  ...
  uint32_t Reserved5C;                /*!< Reserved                                     05Ch */
  __IO uint32_t GADPCTL;              /*!< ADP Timer, Control and Status Register       60Ch */
  uint32_t  Reserved64[39];           /*!< Reserved                                064h-0FFh */
...
typedef struct
{
  ...
  uint32_t  Reserved48[15];      /*!< Reserved                 848-883h */
...
#define USB_OTG_GUSBCFG_HSCURFE_Pos              (4U)
#define USB_OTG_GUSBCFG_HSCURFE_Msk              (0x1UL << USB_OTG_GUSBCFG_HSCURFE_Pos) /*!< 0x00000010 */
#define USB_OTG_GUSBCFG_HSCURFE                  USB_OTG_GUSBCFG_HSCURFE_Msk     /*!< HS current software enable */
#define USB_OTG_GUSBCFG_HSPHYSEL_Pos             (5U)
#define USB_OTG_GUSBCFG_HSPHYSEL_Msk             (0x1UL << USB_OTG_GUSBCFG_HSPHYSEL_Pos) /*!< 0x00000040 */
#define USB_OTG_GUSBCFG_HSPHYSEL                 USB_OTG_GUSBCFG_HSPHYSEL_Msk    /*!< embedded HS PHY selected */
#define USB_OTG_GUSBCFG_FSPHYSEL_Pos             (6U)
#define USB_OTG_GUSBCFG_FSPHYSEL_Msk             (0x1UL << USB_OTG_GUSBCFG_FSPHYSEL_Pos) /*!< 0x00000040 */
#define USB_OTG_GUSBCFG_FSPHYSEL                 USB_OTG_GUSBCFG_FSPHYSEL_Msk    /*!< embedded FS PHY selected */
